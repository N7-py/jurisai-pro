...
Cite a MINIMUM of 5 relevant Supreme Court or High Court judgments. For EACH case, you MUST provide:
- Case name and year (e.g., *AIR 2005 SC 3109*)
- A highly detailed case summary (at least 6-8 sentences) explaining the background, important factors, facts, and outcome.
- The statutory provisions, specific Legal Sections (e.g. Section 2(b) of the Contempt of Courts Act), and the exact legal framework the Court used to favour the case verdict.
- The critical points and ratio decidendi established in the judgment.
- Detailed Application to Present Facts: A comprehensive, multi-sentence explanation of exactly how this case is relevant to the user's specific scenario. DO NOT provide a one-line summary. You must draw direct parallels between the important factors of the cited case and the user's facts.
...
- **Legal Framework & Sections:** The verdict heavily interpreted **Section 2(b) of the Contempt of Courts Act, 1971**, specifically dissecting the definition of a "wilful breach of an undertaking given to a court". The framework used to favor the appellant was that statutory contempt requires strict proof of a direct undertaking, overriding general equitable principles of consent decrees.
...
- **Detailed Application to Present Facts:** This case is highly relevant because it dictates the core threshold for establishing civil contempt when dealing with policy statements. In your specific scenario involving the SEPL scheme, the Advocate General's statement was recorded in the order dated 14.12.2023. If that statement was a mere declarative policy assurance rather than a solemn, explicit undertaking "to the Court," the subsequent suspension by the new government via the GR dated 11.01.2024 will likely completely fail to meet the strict threshold for civil contempt established in *Babu Ram Gupta*. The direct parallel here is evaluating whether the AG's statement legally qualifies as a binding undertaking or just a procedural statement of fact.
...
- **Legal Framework & Sections:** The Court applied **Section 2(b) of the Contempt of Courts Act, 1971**, intertwining it with **Order 39 Rule 2A of the Civil Procedure Code (CPC)**. The legal framework favoring the Bank of Baroda established that when a consent decree incorporates an undertaking restricting property alienation, breaching that restriction triggers statutory contempt jurisdiction rather than merely acting as a breach of contract.
...
- **Detailed Application to Present Facts:** This judgment strongly supports the argument that the subsequent suspension constitutes actionable civil contempt, provided the petitioner satisfies a dual requirement. First, the petitioner must prove that the Advocate General's statement regarding the SEPL scheme on 14.12.2023 was unambiguously intended as a binding undertaking. Second, they must demonstrate that the High Court actively relied upon this undertaking to definitively dispose of the writ petition. If this factual parallel is established, the State Government's issuance of the GR dated 11.01.2024 to suspend the SEPL scheme constitutes a "wilful breach" under Section 2(b), mirroring perfectly the debtors' illicit encumbrance of properties in *Bank of Baroda*.
...
- **Legal Framework & Sections:** The Supreme Court invoked its inherent powers under **Article 129 of the Constitution of India** read with **Section 12 and Section 2(b) of the Contempt of Courts Act, 1971**. Additionally, the framework involved the **Drugs and Magic Remedies (Objectionable Advertisements) Act, 1954**. The verdict favored the prosecution by establishing that corporate directors are vicariously liable for contempt when breaching undertakings made on behalf of the corporate entity by its counsel.
...
- **Detailed Application to Present Facts:** The Patanjali case conclusively shuts down any potential State defense claiming that the Advocate General's statement merely represented a previous administration and thus cannot legally bind the current government. The direct parallel is corporate/state vicarious liability: just as the Patanjali directors were held strictly liable for the brazen breach of an undertaking made by their respective legal counsel, the State of Maharashtra remains legally bound by the solemn assurances made by its Advocate General, regardless of subsequent political elections or changes in administration. Therefore, the implementation suspension via the GR dated 11.01.2024 directly triggers the contempt jurisdiction by violating the recorded guarantees submitted to the High Court.
